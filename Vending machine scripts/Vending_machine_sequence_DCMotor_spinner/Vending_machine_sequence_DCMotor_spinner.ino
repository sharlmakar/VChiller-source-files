...
void loop() {
  ...
  switch (Step) {
    ...
    case 6: //digitalWrite(Winch_approv, LOW);
      ...
      analogWrite(spin_LEFT, 0);
      digitalWrite(DCPump, HIGH);
      servo_motor2.write(0); //Lock on spinner drops bottle to cold storage
      break;
    case 7: //digitalWrite(Winch_approv, LOW);
      servo_motor2.write(180); //Lock on spinner returns to open position to wait for next bottle
      break;
